 ...
 */
public interface EzDownloadStatus {

    /**
     * EzDownloadStatus when the download is currently pending.
     */
    ...
    /**
     * EzDownloadStatus when the download network call is connecting to destination.
     */
    int STATUS_CONNECTING = 1 << 2;

    /**
     * EzDownloadStatus when the download is currently running.
     */
    int STATUS_RUNNING = 1 << 3;

    /**
     * EzDownloadStatus when the download has successfully completed.
     */
    int STATUS_SUCCESSFUL = 1 << 4;

    /**
     * EzDownloadStatus when the download has failed.
     */
    int STATUS_FAILED = 1 << 5;

    /**
     * EzDownloadStatus when the download has failed due to broken url or invalid download url
     */
    int STATUS_NOT_FOUND = 1 << 6;

    /**
     * EzDownloadStatus when the download is attempted for retry due to connection timeouts.
     */
